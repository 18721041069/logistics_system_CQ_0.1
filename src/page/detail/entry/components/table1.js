...
const title = () => '入库单信息';
const footer = () => '入库单一式三联，第一联：送货人联；第二联：财务联；第三联：仓库存查。';
...
const mapState = (state) => ({
    columns: state.getIn(['entry', 'columns1']),
    data: state.getIn(['entry', 'entry_data_1']),
});
...
const mapDispatchToProps = (dispatch) => ({
    ...
    getTableData(){
        dispatch(actionCreators.getTable1Data());
    }
});
